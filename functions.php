...
function techie_widgets_init() {
	$widgets = array(
		...
		array('id' => 'below-latest','name'=>'ताजा अपडेटको तल' ),
		array('id' => 'before-artha-full','name'=>'अर्थको माथि' ),
		array('id' => 'before-artha-small-left','name'=>'अर्थको माथि सानो दायाँ' ),
		array('id' => 'before-artha-small-right','name'=>'अर्थको माथि सानो बायाँ' ),
		array('id' => 'after-artha-full','name'=>'अर्थको तल' ),
		array('id' => 'after-artha-small-left','name'=>'अर्थको तल सानो दायाँ' ),
		array('id' => 'after-artha-small-right','name'=>'अर्थको तल सानो बायाँ' ),
		array('id' => 'after-pradesh-full','name'=>'प्रदेशको तल'),
		array('id' => 'after-litreture-full','name'=>'साहित्यको तल' ),
		array('id' => 'above-international','name'=>'अन्तर्राष्ट्रियको माथि'),
		array('id' => 'below-international','name'=>'अन्तर्राष्ट्रियको तल'),
		...
		array('id' => 'before-trending','name'=>'भित्रको पेजमा ट्रेण्डिङको माथि' ),
